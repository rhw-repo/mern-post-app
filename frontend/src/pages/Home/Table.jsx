...
/* Filter table rows according to selected options 
(all the tags in document collection) */
...
function Table({ data }) {
  ...
  /* Clear pagination selections or 
  global/column/date range filters */
  const resetTable = () => {
    setGlobalFilter("");
    setPageSize(3);
  ...
  /* Combine to pass into return statement, 
  to avoid inline event handlers */
