        ...
        <table {...getTableProps()} className={styles.tableNoGaps}>
          ...
          <thead>
            {headerGroups.map((headerGroup) => (
              /* getHeaderGroupProps() and getHeaderProps() provide the key, however -
              ESLint warning "each child in a list should have a unique 'key' prop"
              Workaround is destructure key property from getHeaderGroupProps() then
              getHeaderProps() using JS dot notation */
              ...
              return (
                <tr {...row.getRowProps()} className={styles.tableRow}>
                  {row.cells.map((cell) => {
                    ...
                    return (
                      <td
                      /* destructure keys property to avoid ESLint warning */
